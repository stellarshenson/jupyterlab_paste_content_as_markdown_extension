...
# Change directory to the jupyterlab_paste_content_as_markdown_extension directory
...
folder is located. Then you can remove the symlink named `jupyterlab_paste_content_as_markdown_extension` within that folder.
